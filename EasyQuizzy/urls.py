...
urlpatterns = [
    ...
    path('dayQuestion', views_guest_and_reg.dayQuestion, name='dayQuestion'),
    ...
    # path('tick', viewsIlija.tick, name='tick'),
    path('answered', viewsIlija.answer, name='answer'),
    path('answered_GET', viewsIlija.answer_GET, name='answer_GET'),
    path('grading', viewsIlija.load_grading, name='load_grading'),
    path('fifty_fifty', viewsIlija.fifty_fifty, name='fifty_fifty'),
    path('fifty_fifty_GET', viewsIlija.fifty_fifty_GET, name='fifty_fifty_GET'),
    path('new_question', viewsIlija.replace, name='replace'),
    path('no_answer', viewsIlija.no_answer, name='no_answer'),
    path('question_of_the_day', viewsIlija.question_of_the_day, name='question_of_the_day'),
    path('question_of_the_day_GET', viewsIlija.question_of_the_day_GET, name='question_of_the_day_GET')
]
